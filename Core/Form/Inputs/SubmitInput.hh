 ...
 *
 * Generate a <input type="submit"> tag.
 *
 * @author Sulivan
 */
class SubmitInput extends FormInput{
   ...
   * @param  bool $render_label True if the label must be rendered, else false (default false).
   */
  ...
  /**
   * Return the xhp element of the input (a <input type="submit"> element).
   *
